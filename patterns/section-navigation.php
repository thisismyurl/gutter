 ...
 * Slug: margin/section-navigation
 ...
 */
?>
<!-- wp:group {"className":"margin-section-nav","style":{"spacing":{"padding":{"top":"var:preset|spacing|4","bottom":"var:preset|spacing|4","left":"var:preset|spacing|5","right":"var:preset|spacing|5"}},"border":{"bottom":{"color":"var:preset|color|rule","style":"solid","width":"1px"}},"color":{"background":"var:preset|color|ground"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group margin-section-nav has-background" style="border-bottom:1px solid var(--wp--preset--color--rule);background-color:var(--wp--preset--color--ground);padding-top:var(--wp--preset--spacing--4);padding-bottom:var(--wp--preset--spacing--4);padding-left:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5)">
