 ...
 * is inc/bootstrap.php (the namespace + the GUTTER_SLUG/GUTTER_VERSION constants).
 *
 * [CORE] This is the portable loader. The `gutter` CLI rewrites the namespace
 * and slug on the way into each theme it generates, so a shipped theme's
 * functions.php is byte-for-byte this file with `Gutter`/`gutter` swapped
